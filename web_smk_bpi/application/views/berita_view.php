	...
	<div class="services">
		<div class="container">
			...
			<?php foreach ($berita as $a){?>
				<h1><a href="<?php echo base_url('welcome'); ?>" ></a> <?php echo $a->judul_berita; ?></h1>
				<h5> Tanggal Posting: <?php echo date("d F Y", strtotime($a->tgl_posting)); ?> </h5>
				<h5> Penulis: <?php echo $a->nama_user; ?> </h5>
			</div>
			<hr/>
			...
			<div class="services-bottom">
				...
				<div class="col-md-12" style="margin-bottom: 30px;">
					<center>
						<img width="50%" src="<?php echo base_url('asset/images/'.$a->gambar_utama); ?>" />
					</center>
				</div>
				<?php } ?>
				
				<div class="col-md-12" style="margin-bottom: 30px;">
					<p align="justify"> <?php echo $a->berita; ?> </p>
				</div>
