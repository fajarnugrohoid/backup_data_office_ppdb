				...
				?>
					...
					<div class="news-one-right" style="margin-top: -20px;">
						...
						<?php
						 ...
						 // $text= $a->artikel; $text=character_limiter($text, 200);
						 // $message= $text;
						 // $post = substr($message, 2, $position); 
						?><p><?php //echo $post; ?>  <?php echo character_limiter($a->artikel,200); ?></p>
					</div>
				<?php } ?>
				<div class="col-md-3 w-btn footer-right" >
					<a href="<?php echo base_url('welcome/artikel/'.$a->id_artikel); ?>" target="_blank" class="hvr-shutter-out-horizontal">Selengkapnya</a>
				</div>
