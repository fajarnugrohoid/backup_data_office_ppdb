	...
	<div class="services">
		...
		?>
				<tr>
					...
					<td><a href="<?php echo base_url('welcome/download')."/".$list->struktur_kurikulum; ?>" class="btn btn-info btn-xs" title="Unduh"><span class="glyphicon glyphicon-download-alt"></span></a></td>
				</tr>
		<?php	
			$i++;
			}
