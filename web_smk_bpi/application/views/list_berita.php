			...
			<div class="news-one services-bottom col-md-12" style="padding-bottom: 10px;">
				<?php if(strcmp($a->gambar_utama,"")==0){?>
							<div class="news-one" style="margin-top: -20px;">
								...
								?><p><?php //echo $post; ?>  <?php echo character_limiter($a->berita,800); ?></p>
							</div>
				<?php
				}else{
				?>
					...
					<div class="news-one-right" style="margin-top: -20px;">
						...
						<?php
						 ...
						 // $message= $text;
						 // $post = substr($message, 2, $position); 
						?><p><?php //echo $post; ?>  <?php echo character_limiter($a->berita,200); ?></p>
					</div>
				<?php } ?>
				
				<div class="col-md-6 w-btn news-one-right">
					<a href="<?php echo base_url('welcome/berita/'.$a->id_berita); ?>" target="_blank" class="hvr-shutter-out-horizontal">Selengkapnya</a>
				</div>
			</div>
