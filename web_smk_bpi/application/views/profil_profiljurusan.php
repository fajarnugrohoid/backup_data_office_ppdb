...
<body>
	...
	<div class="services">
		<div class="container">
			...
			<hr/>
			<div class="tab-pane" id="profiljurusan">
			<!--
			tabel jurusan
			-->
				<div class="wrapper tinggigaleri bottomabit">
					...
					<?php
						$i=0;
						$j=0;
						print_r($profiljurusan_pil);
						foreach($profiljurusan_pil as $g){
					...
					?>
							<div class="four wide column">
								<div class="ui segment fotogaleri">
									<a href="<?php echo base_url('welcome/lihat_profil_jurusan')."/".$g->id_jurusan; ?>"><img src="<?php echo base_url('asset/img/'.$g->logo_jurusan);?>" width="100%" title="<?php echo $g->nama_jurusan;?>" alt="Responsive image" /></a>
								</div>
							</div>
						<?php
								if($i==4){
