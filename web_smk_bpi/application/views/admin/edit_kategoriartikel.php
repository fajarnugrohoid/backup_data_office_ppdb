	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_kategoriartikel'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit data Kategori Artikel</h2>
				<?php echo form_open("administrator/proses_edit_kategoriartikel", "class='form-horizontal' role='form'"); ?>
				
				<div class="control-group">
					<label for="kategoriartikel" class="control-label">Kategori Artikel</label>
					<?php foreach($kategoriartikel_ed as $v_kategoriartikel){ ?>
					<div class="controls"><?php echo form_input("kategoriartikel", "", "placeholder='".$v_kategoriartikel->kategori_artikel."' class='form-control' id='kategoriartikel' "); ?><span class="help-block">Isikan Kategori Artikel yang baru</span></div>
				</div>
				<input type="hidden" name="id_kategoriartikel" value="<?php echo $v_kategoriartikel->id_kategori_artikel; ?>">
				<?php } ?>
				<br/>
