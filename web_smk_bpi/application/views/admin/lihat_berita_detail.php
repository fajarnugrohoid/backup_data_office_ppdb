	...
	<div class="col-md-9">   
					...
					<div class="ui grid">
						<div class="row">
							...
							<div class="thirteen wide column">
								...
								<a href="<?php echo base_url('administrator/olah_berita');?>" class="active item">
		...
		<div class="wrapper bottomabit upabit">
			<div class="ui grid">
					...
					<div class="eleven wide column">
						<div class="ui segment">
							...
							<?php if($berita->gambar_utama!=""){ ?>
								<img width="100%" src="<?php echo base_url('asset/images/'.$berita->gambar_utama);?>"><br/>
							<?php } ?>
							<?php echo $berita->berita;?>
							<br/>
							<p>
								<i class="user icon"></i> Diposkan oleh : <?php echo $berita->nama_user;?> |
								<i class="calendar icon"></i> Pada : <?php echo $berita->tgl_posting;?>
							</p>
						</div>
					</div>
					<div class="five wide column">
						<div class="ui segment">
							...
							<table>
								<tr>
									<td>
										<a href="<?php echo base_url('administrator/edit_berita/'.$berita->id_berita.'/'.$berita->tgl_posting);?>" class="ui blue left labeled icon button">
										  <i class="edit icon"></i>
										  Edit Berita
										</a>
									</td>
								...
								<tr>
									<td><br/>
										<a data-toggle="modal" href="#berita<?php echo $berita->id_berita; ?>" class="btn btn-info btn-xs"  title="hapus">
								...
								<tr>
									<td><br/>
										<a href="<?php echo base_url('administrator/olah_berita');?>" class="ui green left labeled icon button" href="">
				...
				<div class="modal fade" id="berita<?php echo $berita->id_berita; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
								<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $berita->judul_berita; ?>"?</h4>
							</div>
							<div class="modal-footer">
								<a href="<?php echo base_url('administrator/hapus_berita')."/".$berita->id_berita; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
							</div>
						</div>
					</div>
				</div>
