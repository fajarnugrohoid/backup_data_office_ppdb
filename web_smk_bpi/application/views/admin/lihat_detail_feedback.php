		...
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				?>
					...
					<tr>
						<th>Isi</th>
						<td><?php echo $list->isi_feedback;?></td>
					</tr>
					<?php if($list->balas_feedback == 0){ ?>
						<tr>
							<th><a href="<?php echo base_url('administrator/lihat_feedback');?>">Kembali</a></th>
							<td><a href="<?php echo base_url('administrator/sudah_tanggapi_feedback')."/".$list->id_feedback."/".$list->tgl_posting; ?>" class="btn btn-info btn-xs" title="Detail"><span class="glyphicon glyphicon-send"> Sudah ditanggapi!</span></a></td>
						</tr>
					<?php }else{?>
						<tr>
							<th><a href="<?php echo base_url('administrator/lihat_feedback');?>">Kembali</a></th>
