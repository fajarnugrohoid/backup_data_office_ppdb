...
?>	
	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			...
			<?php
				$i=$j;
				foreach ($list_kategoriartikel as $list){
			?>
					<tr>
						<td><?php echo $i; ?></td>
						<td><?php echo $list->kategori_artikel; ?></td>
						<td><a href="<?php echo base_url('administrator/edit_kategoriartikel')."/".$list->id_kategori_artikel; ?>" class="btn btn-info btn-xs" title="Ubah"><span class="glyphicon glyphicon-edit"></span></a> <a data-toggle="modal" href="#hapus<?php echo $list->id_kategori_artikel; ?>" data-dismiss="modal" class="btn btn-info btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					
					<div class="modal fade" id="hapus<?php echo $list->id_kategori_artikel; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
									<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $list->kategori_artikel; ?>"?</h4>
								</div>
								<div class="modal-footer">
									 <a href="<?php echo base_url('administrator/hapus_kategoriartikel')."/".$list->id_kategori_artikel; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
								</div>
							</div>
						</div>
					</div>
			...
			?>
				...
				<?php echo form_open("administrator/proses_input_kategoriartikel", "class='form-horizontal' role='form'"); ?>
				<div class="control-group">
					<label for="nip" class="control-label">Kategori Artikel</label>
					<div class="controls"><?php echo form_input("kategoriartikel", "", "class='form-control' id='nip' required"); ?><span class="help-block">Isikan Kategori Artikel yang belum tersedia</span></div>
				</div>
				<br/>
