	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_silabus'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit Silabus</h2>
	
				<?php echo form_open_multipart("administrator/proses_edit_silabus", "class='form-horizontal' role='form'");
				
				foreach($silabus_ed as $silabus){
				?>
				<div class="control-group">
					<label class="control-label" for="file">Silabus</label>
					<div class="controls"><input type="file" name="file_silabus"></input><span class="help-block">Format gambar harus *.pdf</span></div>
				</div>
				<div class="control-group">
					<label for="mapel" class="control-label">Mata Pelajaran</label>
					<div class="controls"><?php echo form_input("mapel", $silabus->mata_pelajaran, "class='form-control' id='mapel' placeholder=''"); ?><span class="help-block">Hanya diperbolehkan menggunakan karakter alfabet a-z, A-Z, 0-9, - (dash), _ (underscore), dan . (titik) serta boleh terdapat spasi.</span></div>
				</div>
				<div class="control-group">
					<label for="tahun" class="control-label">Tahun Berlaku</label>
					<div class="controls"><?php echo form_input("tahun", $silabus->tahun_berlaku, "class='input-xxlarge' id='tahun' placeholder=''"); ?></div>
				</div>
				<input type="hidden" name="id_silabus" value="<?php echo $silabus->id_silabus;?>">
