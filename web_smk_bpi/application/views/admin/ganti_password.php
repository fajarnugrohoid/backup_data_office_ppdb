	...
	<div class="col-md-9">   
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<?php echo form_open('administrator/pass_action','class="well form-horizontal"'); ?>
					<div class="control-group">
						<label class="control-label" for="password_lama">Password Lama</label>
						<div class="controls"><input type="text" name="password_lama" placeholder="Masukkan Password Lama" value="<?php echo set_value('password_lama'); ?>" class="form-control"  id="password_lama"></div>
					</div>
					<div class="control-group">
						<label class="control-label" for="password_baru">Password Baru</label>
						<div class="controls"><input type="text" name="password_baru" placeholder="Masukkan Password Baru" value="<?php echo set_value('password_baru');?>" class="form-control" id="password_baru"></div>
					</div>
					<div class="control-group">
						<label class="control-label" for="konfirmasi_password_baru">konfirmasi Password Baru</label>
						<div class="controls"><input type="text" name="konfirmasi_password_baru" placeholder="Konfirmasi Password Baru" value="<?php echo set_value('konfirmasi_password_baru');?>" class="form-control" id="konfirmasi_password_baru"></div>
					</div>
