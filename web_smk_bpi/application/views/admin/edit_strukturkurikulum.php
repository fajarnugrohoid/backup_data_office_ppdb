	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_strukturkurikulum'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit Struktur Kurikulum</h2>
	
				<?php echo form_open_multipart("administrator/proses_edit_strukturkurikulum", "class='form-horizontal' role='form'");
				
				foreach($strukturkurikulum_ed as $strukturkurikulum){
				?>
				<div class="control-group">
					<label class="control-label" for="file">Struktur_kurikulum</label>
				...
				<input type="hidden" name="id_strukturkurikulum" value="<?php echo $strukturkurikulum->id_struktur_kurikulum;?>">
				...
				<div class="control-group">
					...
					<select name="jurusan">
						...
						foreach($jurusan_pil as $jur){
							if(strcmp($jur->id_jurusan, $strukturkurikulum->id_jurusan)==0){
						?>
				...
				<?php foreach($strukturkurikulum_ed as $strukturkurikulum){ ?>
				<div class="control-group">
					<label for="tahun" class="control-label">Tahun Berlaku</label>
					<div class="controls"><?php echo form_input("tahun", $strukturkurikulum->tahun_berlaku, "class='input-xxlarge' id='tahun' placeholder=''"); ?></div>
				</div>
				<div class="checkbox">
					<label>
