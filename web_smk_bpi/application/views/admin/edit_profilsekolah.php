...
?>	
	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			...
			<?php
			foreach ($profilsekolah_ed as $list){
			?>
				<tr>
					<td colspan="3"><img align="center" width="750px" height="300px" src="<?php echo base_url('asset/img/'.$list->foto_profil); ?>"></img></td>
				</tr>
				<tr>
					<td rowspan="5"><img width="150px" height="150px" src="<?php echo base_url('asset/img/'.$list->logo); ?>"></img></td>
				</tr>
				<tr>
					<th>Nama</th>
				...
				<tr>
					<th>Sambutan</th>
					<td colspan="2"><?php echo $list->sambutan_kepsek; ?></td>
				</tr>
				<tr>
					<th>Deskripsi</th>
					<td colspan="2"><?php echo $list->deskripsi; ?></td>
				</tr>
		...
		?>
			...
			<?php echo form_open_multipart("administrator/proses_edit_profilsekolah", "class='form-horizontal' role='form'"); 
			
			foreach($profilsekolah_ed as $sekolah){
			?>
				<div class="control-group">
					<label class="control-label" for="logo">Logo</label>
					<div class="controls"><input type="file" name="logo" multiple="multiple"></input><span class="help-block">Format gambar *.jpg, *.png, dan *.gif</span></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="foto_profil">Foto Profil</label>
					<div class="controls"><input type="file" name="foto_profil" multiple="multiple"></input><span class="help-block">Format gambar *.jpg, *.png, dan *.gif</span></div>
				</div>
				<div class="control-group">
					<label for="nama" class="control-label">Nama</label>
					<div class="controls"><?php echo form_input('nama', $sekolah->nama_sekolah, 'class="form-control" id="nama" placeholder="Nama Sekolah" /required'); ?></div>
				</div>
				<div class="control-group">
					<label for="alamat" class="control-label">Alamat</label>
					<div class="controls"><?php echo form_input('alamat', $sekolah->alamat, 'placeholder="Masukan alamat" id="alamat" class="form-control" type="text" /required'); ?></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="kontak">Kontak</label>
					<div class="controls"><?php echo form_input('kontak', $sekolah->no_kontak, 'class="form-control" type="number" placeholder="No Telp/Fax Sekolah" id="kontak  /required'); ?></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="email">Email</label>
					<div class="controls"></div>
					<input type="email" class="form-control" placeholder="Masukan Email" name="email" value="<?php echo $sekolah->email; ?>" /required></input>
				</div>
				<div class="control-group">
					<label for="sambutan" class="control-label">Sambutan Kepala Sekolah</label>
					<div class="controls"><?php echo form_textarea('sambutan', $sekolah->sambutan_kepsek, 'placeholder="Masukan Sambutan" id="sambutan" class="form-control"'); ?></div>
				</div>
				<div class="control-group">
					<label for="deskripsi" class="control-label">Deskripsi</label>
					<div class="controls"><?php echo form_textarea('deskripsi', $sekolah->deskripsi, 'placeholder="Masukan Deskripsi" id="deskripsi" class="form-control"'); ?></div>
				</div>
			<?php } ?>
			<br/>
			<div class="form-action">	
				<?php echo form_submit("simpan", "Simpan Perubahan", "class='btn btn-primary'"); ?>
				<?php echo form_reset("reset", "Bersihkan/Urungkan", "class='btn btn-warning'"); ?>
			</div>
			<?php echo form_close(); ?>
			<br/>
			</div>
