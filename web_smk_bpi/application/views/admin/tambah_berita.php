		...
		<div class="ui segment">
			<div class="row">
				<div class="sixteen wide column">
					...
					<?php echo form_open_multipart('administrator/proses_tambah_berita');?>
					<div class="ui form">
						<h1>Tambah Berita</h1>
						<div class="field">
							<label>Judul</label>
						...
						<input type="submit" class="ui green submit button" value="Tambah Berita"/><br/><br/>
						<a href="<?php echo base_url('administrator/olah_berita');?>">Kembali</a>
					</div>
					</form><br/>
				</div>
			</div>
