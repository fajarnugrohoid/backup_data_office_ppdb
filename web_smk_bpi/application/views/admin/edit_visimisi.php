		...
		<div style="width:100%; float:left; border:1px solid;">
			...
			?>
				...
				<?php
					foreach ($visimisi_ed as $list){
				?>
						<?php echo form_open("administrator/proses_edit_visimisi", "class='form-horizontal' role='form' name='myform'"); ?>
						<div class="control-group">
							<label for="visi" class="control-label">Visi</label>
							<div class="controls"><?php echo form_textarea('visi', $list->visi, 'id="visi" class="input-xxlarge" /required'); ?></div>
						</div>
						<div class="control-group">
							<label for="misi" class="control-label">Misi</label>
							<div class="controls"><?php echo form_textarea('misi', $list->misi, 'id="misi" class="input-xxlarge" /required'); ?></div>
						</div>
						<br/>
