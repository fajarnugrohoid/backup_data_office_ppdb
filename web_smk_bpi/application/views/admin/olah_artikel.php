	...
	<div class="wrapper bottomabit">
		<div class="ui segment">
			...
			<table class="ui table segment">
				...
				<tbody>
					<?php $i=$j; foreach($artikel as $b){?>
						<tr>
							<td><?php echo $i;?></td>
							<td><?php echo $b->judul_artikel;?></td>
							<td><?php echo $b->tgl_posting;?></td>
							<td>
								<a href="<?php echo base_url('administrator/lihat_artikel_detail/'.$b->id_artikel.'/'.$b->tgl_posting);?>" class="ui tiny orange right labeled icon button" href="">
			...
			<br/>
			<a href="<?php echo base_url('administrator/tambah_artikel');?>" class="ui green left labeled icon button" href="">
			  <i class="add icon"></i>
			  Tambah Artikel
			</a>
			<br/>
