	...
	<div class="wrapper bottomabit">
		<div class="ui segment">
			...
			<table class="ui table segment">
				...
				<tbody>
					<?php $i=$j; foreach($berita as $b){?>
						<tr>
							<td><?php echo $i;?></td>
							<td><?php echo $b->judul_berita;?></td>
							<td><?php echo $b->tgl_posting;?></td>
							<td>
								<a href="<?php echo base_url('administrator/lihat_berita_detail/'.$b->id_berita.'/'.$b->tgl_posting);?>" class="ui tiny orange right labeled icon button" href="">
			...
			<a href="<?php echo base_url('administrator/tambah_berita');?>" class="ui green left labeled icon button" href="">
			  <i class="add icon"></i>
			  Tambah Berita
			</a>
			<br/><br/>
