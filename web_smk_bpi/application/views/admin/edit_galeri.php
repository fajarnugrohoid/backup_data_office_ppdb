	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_galeri'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit Galeri</h2>
	
				<?php echo form_open_multipart("administrator/proses_edit_galeri", "class='form-horizontal' role='form'");
				
				foreach($galeri_ed as $galeri){
				?>
				<div class="control-group">
					<label for="judul_galeri" class="control-label">Judul Galeri</label>
					<div class="controls"><?php echo form_input("judul_galeri", $galeri->judul_galeri, "class='form-control' id='judul_galeri' placeholder=''"); ?><span class="help-block">Hanya diperbolehkan menggunakan karakter alfabet a-z, A-Z, 0-9, - (dash), _ (underscore), dan . (titik) serta boleh terdapat spasi.</span></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="foto">Foto</label>
					<div class="controls"><input type="file" name="foto_upload"></input><span class="help-block"><i>format file gambar harus <b>*.png, *.jpg, *.jpeg, atau *.gif</b></i></span></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="deskripsi">Deskripsi</label>
					<div class="controls"><?php echo form_textarea('deskripsi', $galeri->deskripsi, 'placeholder="" id="deskripsi" class="form-control" /required'); ?></div>
				</div>
				...
				<div class="control-group">
					...
					<select name="kategori">
						...
						foreach($kategori_pil as $kat){
							if(strcmp($kat->id_kategori_artikel, $galeri->id_kategori)===0){
						?>
