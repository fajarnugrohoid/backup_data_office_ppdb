		...
		<div class="ui segment">
			<div class="row">
				<div class="sixteen wide column">
					...
					<?php echo form_open_multipart('administrator/proses_tambah_bursa_kerja');?>
					<div class="ui form">
						...
						<input type="submit" class="ui green submit button" value="Tambah Bursa Kerja"/><br/><br/>
						<a href="<?php echo base_url('administrator/olah_bursa_kerja');?>">Kembali</a>
					</div>
					</form><br/>
				</div>
			</div>
