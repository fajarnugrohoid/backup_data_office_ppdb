		...
		<div class="ui segment">
			<div class="row">
				<div class="sixteen wide column">
					...
					<?php echo form_open_multipart('administrator/proses_edit_berita');?>
					<div class="ui form">
						<h1>Ubah Berita</h1>
						<div class="field">
							<label>Judul</label>
							<input type="text" name="judul" value="<?php echo $berita->judul_berita;?>" /required>
						...
						<div class="field">
							<label>Isi</label>
							<textarea name="isi"><?php echo $berita->berita;?></textarea>
						</div>
						<div class="checkbox">
							<label>
						...
						<input type="submit" class="ui green submit button" value="Simpan Berita"/><br/><br/>
						<a href="<?php echo base_url('administrator/lihat_berita_detail/'.$berita->id_berita);?>">Kembali</a>
					</div>
					</form><br/>
				</div>
			</div>
