...
?>	
	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			...
			<?php
				$j=$i;
				foreach ($list_unitkerja as $list){
			?>
					<tr>
						<td><?php echo $j; ?></td>
						<td><?php echo $list->unit_kerja; ?></td>
						<td><?php $text=$list->deskripsi; $text=character_limiter($text, 50); echo $text;?></td>
						<td><a data-toggle="modal" href="#detail<?php echo $list->id_unit_kerja; ?>" class="btn btn-info btn-xs" title="Detail"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp;<a data-toggle="modal" href="#hapus<?php echo $list->id_unit_kerja; ?>" class="btn btn-info btn-xs" title="hapus"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					
					<div class="modal fade" id="hapus<?php echo $list->id_unit_kerja; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
									<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $list->unit_kerja; ?>"?</h4>
								</div>
								<div class="modal-footer">
									<a href="<?php echo base_url('administrator/hapus_unitkerja')."/".$list->id_unit_kerja; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
								</div>
							</div>
						</div>
					</div>
			...
			?>
				...
				<?php echo form_open("administrator/proses_input_unitkerja", "class='form-horizontal' role='form'"); ?>
				<div class="control-group">
					<label for="unit_kerja" class="control-label">Unit Kerja</label>
					<div class="controls"><?php echo form_input('unit_kerja', $this->session->flashdata('unitkerja'), 'class="form-control" id="unit_kerja" /required'); ?><span class="help-block">Isikan Unit Kerja yang belum tersedia</span></div>
				</div>
				<div class="control-group">
			...
			?>
					<!-- Modal -->
					<div class="modal fade" id="detail<?php echo $list->id_unit_kerja; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
								...
								<div class="modal-body">
									<table class="table table-hover table-responsive">
										<tr><td>Unit Kerja</td><td>:</td><td><?php echo $list->unit_kerja; ?></td></tr>
										<tr><td>Deskripsi</td><td>:</td><td><?php echo $list->deskripsi; ?></td></tr>
									</table>
								</div>
								<div class="modal-footer">
									<a href="<?php echo base_url('administrator/edit_unitkerja')."/".$list->id_unit_kerja; ?>" class="btn btn-info btn-xs" title="Ubah"><span class="glyphicon glyphicon-edit"></span></a>
								</div>
							</div>
						</div>
					</div>
