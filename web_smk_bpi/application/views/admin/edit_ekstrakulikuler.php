	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_ekstrakulikuler'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit data Ekstrakulikuler</h2>
				
				<?php require_once('tinymce.php') ?>
				<?php echo validation_errors(); ?>
				<?php echo form_open("administrator/proses_edit_ekstrakulikuler", "class='form-horizontal' role='form'"); ?>
				<div class="control-group">
					<label for="ekstrakulikuler" class="control-label">Ekstrakulikuler</label>
					<?php foreach($ekstrakulikuler_ed as $v_ekstrakulikuler){ ?>
					<div class="controls"><?php echo form_input("ekstrakulikuler", $v_ekstrakulikuler->nama_ekstrakulikuler, "class='form-control' id='ekstrakulikuler' required"); ?><span class="help-block">Isikan Ekstrakulikuler yang baru</span></div>
				</div>
				<div class="control-group">
					<label class="control-label" for="deskripsi">Deskripsi</label>
					<div class="controls"><?php echo form_textarea('deskripsi', $v_ekstrakulikuler->deskripsi, 'placeholder="Masukan Deskripsi" id="deskripsi" class="input-xxlarge" /required'); ?></div>
				</div>
				<input type="hidden" name="id_ekstrakulikuler" value="<?php echo $v_ekstrakulikuler->id_ekstrakulikuler; ?>">
				<?php } ?>
				<div class="control-group">
					...
					<select name="pembina">
						...
						foreach($kepegawaian_pil as $pegawai){
							if($pegawai->id_pegawai == $v_ekstrakulikuler->id_pegawai){
						?>
