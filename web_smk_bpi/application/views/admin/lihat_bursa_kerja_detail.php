	...
	<div class="col-md-9">   
		...
		<div class="wrapper bottomabit upabit">
			<div class="ui grid">
				<div class="row">
					<div class="eleven wide column">
						<div class="ui segment">
							<h2><?php echo $bursa_kerja->judul_bursa_kerja;?></h2>
							<?php if($bursa_kerja->gambar_utama!=""){ ?>
								<img width="100%" src="<?php echo base_url('asset/images/'.$bursa_kerja->gambar_utama);?>"><br/>
							<?php } ?>
							<?php echo $bursa_kerja->bursa_kerja;?>
							<br/>
							<p>
								<i class="calendar icon"></i> Pada : <?php echo $bursa_kerja->tgl_posting;?>
							</p>
						</div>
					</div>
					<div class="five wide column">
						<div class="ui segment">
							...
							<table>
								<tr>
									<td>
										<a href="<?php echo base_url('administrator/edit_bursa_kerja/'.$bursa_kerja->id_bursa_kerja.'/'.$bursa_kerja->tgl_posting);?>" class="ui blue left labeled icon button">
										  <i class="edit icon"></i>
										  Edit Bursa Kerja
										</a>
									</td>
								...
								<tr>
									<td><br/>
										<a data-toggle="modal" href="#bursa_kerja<?php echo $bursa_kerja->id_bursa_kerja; ?>" class="btn btn-info btn-xs"  title="hapus">
								...
								<tr>
									<td><br/>
										<a href="<?php echo base_url('administrator/olah_bursa_kerja');?>" class="ui green left labeled icon button" href="">
				...
				<div class="modal fade" id="bursa_kerja<?php echo $bursa_kerja->id_bursa_kerja; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
								<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $bursa_kerja->judul_bursa_kerja; ?>"?</h4>
							</div>
							<div class="modal-footer">
								<a href="<?php echo base_url('administrator/hapus_bursa_kerja')."/".$bursa_kerja->id_bursa_kerja; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
							</div>
						</div>
					</div>
				</div>
