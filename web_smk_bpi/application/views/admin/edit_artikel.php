		...
		<div class="ui segment">
			<div class="row">
				<div class="sixteen wide column">
					...
					<?php echo form_open_multipart('administrator/proses_edit_artikel');?>
					<div class="ui form">
						<h1>Ubah Artikel</h1>
						<div class="field">
							<label>Judul</label>
							<input type="text" name="judul" value="<?php echo $artikel->judul_artikel;?>" /required>
						...
						<div class="field">
							<label>Isi</label>
							<textarea name="isi"><?php echo $artikel->artikel;?></textarea>
						</div>
						<div class="field">
						...
						<select name="kategori">
							...
							foreach($kategori as $kat){
								if($kategori->id_kategori_artikel==$artikel->id_kategori){
							?>
						...
						<input type="submit" class="ui green submit button" value="Simpan Artikel"/><br/><br/>
						<a href="<?php echo base_url('administrator/lihat_artikel_detail/'.$artikel->id_artikel);?>">Kembali</a>
					</div>
					</form><br/>
				</div>
			</div>
