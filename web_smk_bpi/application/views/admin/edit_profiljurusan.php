	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_profiljurusan'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit data Jurusan</h2>
				
				<?php require_once('tinymce.php') ?>
				<?php echo form_open_multipart("administrator/proses_edit_profiljurusan", "class='form-horizontal' role='form' name='myform' novalidate"); ?>
				...
				<?php foreach($profiljurusan_ed as $v_profiljurusan){ ?>
					<div class="control-group">
						<label for="nama_jurusan" class="control-label">Nama Jurusan</label>
						<div class="controls"><?php echo form_input("nama_jurusan", $v_profiljurusan->nama_jurusan, "class='form-control' id='nama_jurusan' required"); ?><span class="help-block">Isikan Jurusan yang belum tersedia</span></div>
					</div>
				<?php } ?>
				<div class="control-group">
					...
					<select name="ketua_jurusan">
						...
						//echo $ketua->id_pegawai."=".$v_profiljurusan->ketua_jurusan;
								if($ketua->id_pegawai==$v_profiljurusan->ketua_jurusan){ 
						?>
				...
				<?php foreach($profiljurusan_ed as $v_profiljurusan){ ?>
					<div class="control-group">
						...
						<div class="controls"><?php echo form_textarea('deskripsi', $v_profiljurusan->deskripsi, 'placeholder="Masukan Deskripsi" id="deskripsi" class="input-xxlarge" /required'); ?></div>
					</div>
					<input type="hidden" name="id_profiljurusan" value="<?php echo $v_profiljurusan->id_jurusan; ?>">
				<?php } ?>
				<br/>
