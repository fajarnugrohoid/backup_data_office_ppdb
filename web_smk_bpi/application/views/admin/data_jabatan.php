		...
		<div style="width:100%; float:left; border:1px solid;">
			...
			?>
					<tr>
						...
						?></td>
						<td><?php echo $list->urut; ?></td>
						<td><a href="<?php echo base_url('administrator/edit_jabatan')."/".$list->id_jabatan; ?>" class="btn btn-info btn-xs" title="Ubah"><span class="glyphicon glyphicon-edit"></span></a> <a data-toggle="modal" href="#hapus<?php echo $list->id_jabatan; ?>" class="btn btn-info btn-xs" title="hapus"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					
					<div class="modal fade" id="hapus<?php echo $list->id_jabatan; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
									<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $list->jabatan; ?>"?</h4>
								</div>
								<div class="modal-footer">
									<a href="<?php echo base_url('administrator/hapus_jabatan')."/".$list->id_jabatan; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
								</div>
							</div>
						</div>
					</div>
			...
			?>
				...
				<?php echo form_open("administrator/proses_input_jabatan", "class='form-horizontal' role='form'"); ?>
				<div class="control-group">
					<label for="jabatan" class="control-label">Jabatan</label>
					<div class="controls"><?php echo form_input("jabatan", "", "class='form-control' id='jabatan' /required"); ?><span class="help-block">Isikan Jabatan yang belum tersedia</span></div>
				</div>
				<div class="control-group">
					<label for="status" class="control-label">Status</label>
					<div class="controls">
						<select name="status" id="status">
							<option value="1">Hanya 1</option>
							<option value="0">Lebih dari 1</option>
						</select>
					</div>
				</div><br/>
				<div class="control-group">
					<label for="urut" class="control-label">Jajaran</label>
					<div class="controls">
						<select name="jajaran" id="urut">
							<?php for($urut=1;$urut<=10;$urut++){ ?>
								<option value="<?php echo $urut; ?>"><?php echo $urut; ?></option>
							<?php } ?>
						</select>
					</div>
					<span class="help-block">Jajaran digunakan untuk mengurutkan jabatan dari urutan teratas.</span>
				</div>
				<br/>
