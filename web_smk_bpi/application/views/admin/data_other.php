	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			...
			?>
					<tr>
						<td><?php echo $i; ?></td>
						<td><?php echo $list->file_upload; ?></td>
						<td><?php echo $list->judul_upload; ?></td>
						<td><?php echo $list->tgl_posting; ?></td>
						<td><a href="<?php echo base_url('administrator/edit_other')."/".$list->id_other."/". $list->tgl_posting; ?>" class="btn btn-info btn-xs" title="Ubah"><span class="glyphicon glyphicon-edit"></span></a>
						<a data-toggle="modal" href="#<?php echo $list->id_other; ?>" class="btn btn-info btn-xs" title="hapus"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					
					<div class="modal fade" id="<?php echo $list->id_other; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
									<h4 class="modal-title" id="myModalLabel">Hapus "<?php echo $list->judul_upload; ?>"?</h4>
								</div>
								<div class="modal-footer">
									<a href="<?php echo base_url('administrator/hapus_other')."/".$list->id_other; ?>" class="btn btn-danger btn-xs" title="Hapus"><span class="glyphicon glyphicon-trash"></span></a>
			...
			?>
				...
				<hr>
				<h2>Tambah Download Other</h2>
				
				<?php echo form_open_multipart("administrator/proses_input_other", "class='form-horizontal' role='form'"); ?>
				...
				<div class="control-group">
					...
					<div class="controls"><?php echo form_input("judul", $this->session->flashdata('judul'), "class='form-control' id='judul' placeholder=''"); ?><span class="help-block">Hanya diperbolehkan menggunakan karakter alfabet a-z, A-Z, 0-9, - (dash), _ (underscore), dan . (titik) serta boleh terdapat spasi.</span></div>
				</div>
				<br/>
