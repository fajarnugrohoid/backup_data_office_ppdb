	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_infoppdb'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   <b>Edit Info PPDB</b></h2>
				<?php require_once('tinymce.php') ?>
				<?php echo validation_errors(); ?>
				<?php echo form_open("administrator/proses_edit_infoppdb", "class='form-horizontal' role='form' name='myform'"); 
				
				foreach($infoppdb_ed as $ppdb){
				?>
					<div class="control-group">
						<label for="judul" class="control-label">Judul</label>
						<div class="controls"><?php echo form_input('judul', $ppdb->judul_info_ppdb, 'placeholder="" class="form-control" id="judul" /required'); ?></div>
					</div>
					<div class="control-group">
						<label for="info" class="control-label">Info</label>
						<div class="controls"><?php echo form_textarea('info', $ppdb->info_ppdb, 'placeholder="" class="input-xxlarge" id="info" '); ?></div>
					</div>
					<input type="hidden" name="id_infoppdb" value="<?php echo $ppdb->id_info_ppdb;?>">
