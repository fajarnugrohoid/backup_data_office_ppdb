	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<?php echo form_open('administrator/proses_edit') ?>
				...
				<table class="table table-striped" style="font-size: 16px;">
					...
					<<tr>
						...
						<td> : </td>
						<td> <input type="file" name="foto"></input><span class="help-block"><i>format file gambar harus <b>*.png, *.jpg, *.jpeg, atau *.gif</b></i></span> </td>
					</tr>
					<tr>
						<td>NIS</td>
						<td>:</td>
						<td><input type = "text" name = "nis" value = "<?php echo $siswa->nis ?>" class="col-md-12" disabled></td>
					</tr>
					<tr>
						<td>Nama</td>
						<td>:</td>
						<td><input type = "text" name = "nama" value = "<?php echo $siswa->nama ?>" class="col-md-12" required></td>
					</tr>
					<tr>
						<td>Jenis Kelamin</td>
						<td>:</td>
					...
					<tr>
						...
						<td>:</td>
						<td>
							<select name = "kelas" class="col-md-12">
							<?php 
							foreach($kelas as $k){ 
								if($siswa->id_kelas == $k->id_kelas){
							?>
								<option value = "<?php echo $k->id_kelas ?>" selected><?php echo $k->kelas ?></option>
							<?php 
								}
							?>
				...
				<div class="col-md-12" style="float: left; ">
					<h4> <a href = "<?php echo site_url('administrator/siswa') ?>" class="btn btn-inverse" >Kembali</a> </h4>
				</div>
				<br/>
