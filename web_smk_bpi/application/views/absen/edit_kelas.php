	...
	<div class="col-md-9">
		<div style="width:100%; float:left; border:1px solid;">
			<div class="col-xs-12">
				...
				<h2><a href="<?php echo base_url('administrator/input_kelas'); ?>" title="Kembali" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span></a>   Edit data Kelas</h2>
				
				<?php echo form_open("administrator/proses_edit_kelas", "class='form-horizontal' role='form'"); ?>
				
				<div class="control-group">
					<label for="kelas" class="control-label">Kelas</label>
					<?php foreach($kelas_ed as $v_kelas){ ?>
					<div class="controls">
						<?php echo form_input("kelas", "", "placeholder='".$v_kelas->kelas."' class='form-control' id='kelas' "); ?><span class="help-block">Isikan Kelas yang baru</span>
					</div>
				</div>

				<input type="hidden" name="id_kelas" value="<?php echo $v_kelas->id_kelas; ?>">
				<?php } ?>
				<br/>
