	...
	<div class="services">
		<div class="container">
			<div class="services-top heading">
				<h1><?php echo "Ekstrakurikuler" ?></h1>
			</div>
			<hr/>
			...
			<ul class="nav nav-pills nav-stacked">
				...
				<?php
					$j=$i;
					foreach ($list_ekskul as $list){
				?>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<li>
									<a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $list->id_ekstrakulikuler; ?>">
										<?php echo $j.'. '.$list->nama_ekstrakulikuler; ?>
									</a>
								</li>
							</h4>
						</div>
				<?php
					if($j==1){ $kelas="panel-collapse collapse in";}else{ $kelas="panel-collapse collapse";}
				?>
						<!-- collapse -->
						<div id="<?php echo $list->id_ekstrakulikuler; ?>" class="<?php echo $kelas; ?>">
							<div class="panel-body">
								<li>Pembina&nbsp;: <?php echo $list->nama; ?></li>
								<li>Deskripsi&nbsp;: <?php echo $list->deskripsi; ?></li>
							</div>
						</div>
