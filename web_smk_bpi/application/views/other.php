			...
			<div class="container">
				...
				?>
						<tr>
							...
							<td><a href="<?php echo base_url('welcome/download')."/".$list->file_upload; ?>" class="btn btn-info btn-xs" title="Unduh"><span class="glyphicon glyphicon-download-alt"></span></a></td>
						</tr>
				<?php	
					$i++;
					}
