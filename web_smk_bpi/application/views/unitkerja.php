		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse new" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav new">
					...
					<li class="active"><a href="<?php echo base_url('welcome/lihat_unitkerja'); ?>" class="hvr-bounce-to-top">Unit Kerja</a></li>
	...
	<div class="services">
		<div class="container">
			...
			<div class="services-bottom">
				<ul class="nav2 nav nav-tabs nav-justified" id="myTab">
				<?php
					$j=0;
					foreach ($list_unitkerja as $list){
						if($j<1){
				?>
					<li class="active"><a href="#<?php echo $list->id_unit_kerja; ?>" data-toggle="tab"><?php echo $list->unit_kerja; ?></a></li>
				<?php
						$j++;
						}else{
				?>
					<li><a href="#<?php echo $list->id_unit_kerja; ?>" data-toggle="tab"><?php echo $list->unit_kerja; ?></a></li>
				<?php
						}
					}
				?>
				...
				<?php
					...
					foreach ($list_unitkerja as $list){
						if($i<1){
				?>
					<div class="tab-pane active" id="<?php echo $list->id_unit_kerja; ?>">
						<!-- isi -->
					...
					?>
					<div class="tab-pane" id="<?php echo $list->id_unit_kerja; ?>">
						<table class="table table-hover table-responsive">
							<tr>
								<th>Deskripsi :</th>
							</tr>
