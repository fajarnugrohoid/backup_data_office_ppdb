...
<body>
	...
	<div class="services">
		<div class="container">
			...
			<?php foreach ($list_bursa_kerja as $a){?>
			
			<div class="news-one services-bottom col-md-12" >
				<?php if(strcmp($a->gambar_utama,"")==0){?>
							<div class="news-one" style="margin-top: -20px;">
								<h3> <?php echo $a->judul_bursa_kerja; ?> </h3>
								...
								?><p><?php //echo $post; ?>  <?php echo character_limiter($a->bursa_kerja,800); ?></p>
							</div>
				<?php
				}else{
				?>
					<div class="news-one-left">
						<center> 
							<img src="<?php echo base_url('asset/images/'.$a->gambar_utama); ?>" width="25%" />
						</center>
					</div>
					<div class="news-one-right" style="margin-top: -20px;">
						<h3> <?php echo $a->judul_bursa_kerja; ?> </h3>
						<label style="font-size: 12px; margin-bottom: 20px; ">
							<?php echo date("d F Y", strtotime($a->tgl_posting)); ?>
						</label>
						<?php
						 ...
						 // $message= $text;
						 // $post = substr($message, 2, $position); 
						?><p><?php //echo $post; ?>  <?php echo character_limiter($a->bursa_kerja,200); ?></p>
					</div>
				<?php } ?>
				
				<div class="col-md-6 w-btn news-one-right">
					<a href="<?php echo base_url('welcome/bursa_kerja/'.$a->id_bursa_kerja); ?>" target="_blank" class="hvr-shutter-out-horizontal">Selengkapnya</a>
				</div>
