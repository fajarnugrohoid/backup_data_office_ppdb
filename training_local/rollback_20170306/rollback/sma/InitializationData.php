...
class InitializationData extends Database
{
    ...
    public function getSchool()
    {
        ...
        while ($row = mysqli_fetch_array($results_school)) {
            ...
            //history
            $this->historylist[0][$school_idx]['dw']['id'] = $this->listschool[$school_idx]['dw']['id'];
            $this->historylist[0][$school_idx]['dw']['data'] = $this->listschool[$school_idx]['dw']['data'];
            ...
            //history
            $this->historylist[0][$school_idx]['gw']['id'] = $this->listschool[$school_idx]['gw']['id'];
            $this->historylist[0][$school_idx]['gw']['data'] = $this->listschool[$school_idx]['gw']['data'];
            ...
            //history
            $this->historylist[0][$school_idx]['br']['id'] = $this->listschool[$school_idx]['br']['id'];
            $this->historylist[0][$school_idx]['br']['data'] = $this->listschool[$school_idx]['br']['data'];
            ...
            //history
            $this->historylist[0][$school_idx]['lk']['id'] = $this->listschool[$school_idx]['lk']['id'];
            $this->historylist[0][$school_idx]['lk']['data'] = $this->listschool[$school_idx]['lk']['data'];
