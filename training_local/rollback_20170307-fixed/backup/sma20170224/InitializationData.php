...
class InitializationData extends Database
{
    ...
    public function getSchool()
    {
        ...
        while ($row = mysqli_fetch_array($results_school)) {
            ...
            $this->listsekolah[$school_idx]['id']                   = $row['id'];
            $this->listsekolah[$school_idx]['name']                 = $row['name'];
            $this->listsekolah[$school_idx]['quota']                = $row['quota'];
            $this->listsekolah[$school_idx]['old_quota']            = $row['old_quota'];
            $this->listsekolah[$school_idx]['quota_lk']       = $row['quota_lk'];
            $this->listsekolah[$school_idx]['old_quota_lk']   = $row['old_quota_lk'];
            $this->listsekolah[$school_idx]['foreigner_percentage'] = $row['foreigner_percentage'];
            $this->listsekolah[$school_idx]['low_passing_grage']    = 0;

            $this->listsekolah[$school_idx]['dw']['id']                   = $row['id'];
            $this->listsekolah[$school_idx]['dw']['quota']                = $row['quota_dw'];
            $this->listsekolah[$school_idx]['dw']['old_quota_dw']         = $row['old_quota_dw'];
            $this->listsekolah[$school_idx]['dw']['filtered']             = 0;
            $this->listsekolah[$school_idx]['dw']['foreigner_percentage'] = $row['foreigner_percentage'];
            $this->listsekolah[$school_idx]['dw']['passing_grade']        = 0;
            $this->listsekolah[$school_idx]['dw']['remaining_quota']      = 0;

            if (isset($siswa_dw)) {
                $this->listsekolah[$school_idx]['dw']['data'] = $siswa_dw;
            } else {
                $this->listsekolah[$school_idx]['dw']['data'] = array();
            }
            $this->listsekolah[$school_idx]['dw']['status'] = 0;
            unset($siswa_dw);
            ...
            $this->listsekolah[$school_idx]['gw']['id']                   = $row['id'];
            $this->listsekolah[$school_idx]['gw']['quota']                = $row['quota_gw'];
            $this->listsekolah[$school_idx]['gw']['old_quota_gw']         = $row['old_quota_gw'];
            $this->listsekolah[$school_idx]['gw']['filtered']             = 0;
            $this->listsekolah[$school_idx]['gw']['foreigner_percentage'] = $row['foreigner_percentage'];
            $this->listsekolah[$school_idx]['gw']['passing_grade']        = 0;
            $this->listsekolah[$school_idx]['gw']['remaining_quota']      = 0;

            if (isset($siswa_gw)) {
                $this->listsekolah[$school_idx]['gw']['data'] = $siswa_gw;
            } else {
                $this->listsekolah[$school_idx]['gw']['data'] = array();
            }
            $this->listsekolah[$school_idx]['gw']['status'] = 0;
            ...
            $this->listsekolah[$school_idx]['br']['id']                   = $row['id'];
            $this->listsekolah[$school_idx]['br']['quota']                = $row['quota'];
            $this->listsekolah[$school_idx]['br']['quota_lk']       = $row['quota_lk'];
            $this->listsekolah[$school_idx]['br']['filtered']             = 0;
            $this->listsekolah[$school_idx]['br']['foreigner_percentage'] = $row['foreigner_percentage'];
            $this->listsekolah[$school_idx]['br']['passing_grade']        = 0;
            $this->listsekolah[$school_idx]['br']['remaining_quota']      = 0;

            if (isset($siswa_br)) {
                $this->listsekolah[$school_idx]['br']['data'] = $siswa_br;
            } else {
                $this->listsekolah[$school_idx]['br']['data'] = array();
            }
            $this->listsekolah[$school_idx]['br']['status'] = 0;
            ...
            $this->listsekolah[$school_idx]['lk']['id']                   = $row['id'];
            $this->listsekolah[$school_idx]['lk']['quota']                = $row['quota'];
            $this->listsekolah[$school_idx]['lk']['quota_lk']       = $row['quota_lk'];
            $this->listsekolah[$school_idx]['lk']['filtered']             = 0;
            $this->listsekolah[$school_idx]['lk']['foreigner_percentage'] = $row['foreigner_percentage'];
            $this->listsekolah[$school_idx]['lk']['passing_grade']        = 0;
            $this->listsekolah[$school_idx]['lk']['remaining_quota']      = 0;

            if (isset($siswa_lk)) {
                $this->listsekolah[$school_idx]['lk']['data'] = $siswa_lk;
            } else {
                $this->listsekolah[$school_idx]['lk']['data'] = array();
            }
            $this->listsekolah[$school_idx]['lk']['status'] = 0;
            unset($siswa_lk);
        ...
        $this->listsekolah[$school_idx]['id']                   = '9999';
        $this->listsekolah[$school_idx]['name']                 = 'Sekolah Buangan';
        $this->listsekolah[$school_idx]['quota']                = 0;
        $this->listsekolah[$school_idx]['filtered']              = 1;
        $this->listsekolah[$school_idx]['foreigner_percentage'] = 0;

        $this->listsekolah[$school_idx]['old_quota']          = 0;
        $this->listsekolah[$school_idx]['quota_lk']     = 0;
        $this->listsekolah[$school_idx]['old_quota_lk'] = 0;

        $this->listsekolah[$school_idx]['remaining_quota'] = 0;

        $this->listsekolah[$school_idx]['dw']['id']              = '9999';
        $this->listsekolah[$school_idx]['dw']['name']            = 'Buangan';
        $this->listsekolah[$school_idx]['dw']['quota']           = 0;
        $this->listsekolah[$school_idx]['dw']['data']            = array();
        $this->listsekolah[$school_idx]['dw']['status']          = 1;
        $this->listsekolah[$school_idx]['dw']['filtered']        = 1;
        $this->listsekolah[$school_idx]['dw']['remaining_quota'] = 0;

        $this->listsekolah[$school_idx]['gw']['id']              = '9999';
        $this->listsekolah[$school_idx]['gw']['name']            = 'Buangan';
        $this->listsekolah[$school_idx]['gw']['quota']           = 0;
        $this->listsekolah[$school_idx]['gw']['data']            = array();
        $this->listsekolah[$school_idx]['gw']['status']          = 1;
        $this->listsekolah[$school_idx]['gw']['filtered']        = 1;
        $this->listsekolah[$school_idx]['gw']['remaining_quota'] = 0;

        $this->listsekolah[$school_idx]['br']['id']              = '9999';
        $this->listsekolah[$school_idx]['br']['name']            = 'Buangan';
        $this->listsekolah[$school_idx]['br']['quota']           = 0;
        $this->listsekolah[$school_idx]['br']['data']            = array();
        $this->listsekolah[$school_idx]['br']['status']          = 1;
        $this->listsekolah[$school_idx]['br']['filtered']        = 1;
        $this->listsekolah[$school_idx]['br']['remaining_quota'] = 0;

        $this->listsekolah[$school_idx]['lk']['id']              = '9999';
        $this->listsekolah[$school_idx]['lk']['name']            = 'Buangan';
        $this->listsekolah[$school_idx]['lk']['quota']           = 0;
        $this->listsekolah[$school_idx]['lk']['data']            = array();
        $this->listsekolah[$school_idx]['lk']['status']          = 1;
        $this->listsekolah[$school_idx]['lk']['filtered']        = 1;
        $this->listsekolah[$school_idx]['lk']['remaining_quota'] = 0;
